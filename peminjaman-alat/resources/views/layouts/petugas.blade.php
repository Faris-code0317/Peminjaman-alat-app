...
<head>
  ...
  <title>
    Halaman petugas - peminjaman alat
  </title>
  <!--     Fonts and icons     -->
...
document.querySelectorAll('.form-setujui').forEach(form => {
    form.addEventListener('submit', function(e) {
        e.preventDefault();

        Swal.fire({
            title: 'Ingin menyetujui permintaan ini?',
            text: 'Tekan setujui untuk menyetujui!',
            icon: 'warning',
            showCancelButton: true,
            confirmButtonColor: '#198754',
            cancelButtonColor: '#dc3545',
...
document.querySelectorAll('.form-kembalikan').forEach(form => {
    form.addEventListener('submit', function(e) {
        ...
        Swal.fire({
            ...
            text: 'Tekan selesai untuk mengubah status!',
            icon: 'warning',
            showCancelButton: true,
            confirmButtonColor: '#198754',
            cancelButtonColor: '#dc3545',
