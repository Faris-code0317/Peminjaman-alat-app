      ...
      <ul class="navbar-nav">
        ...
        <li class="nav-item">
          <a class="nav-link {{ request()->is('admin/user*') ? 'active' : '' }}" href="/admin/user">
            <div class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
                <i class="fa-solid fa-user text-info text-sm opacity-10"></i>
             </div>
        ...
        <li class="nav-item">
          <a class="nav-link {{ request()->is('admin/kategori*') ? 'active' : '' }}" href="/admin/kategori">
            <div class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
                <i class="fa-solid fa-table-list text-sm opacity-10" style="color: #FFD43B;"></i>
            </div>
        ...
        {{-- <li class="nav-item">
          <a class="nav-link " href="/admin/table">
            <div class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
                <i class="fa-solid fa-person-circle-check text-sm opacity-10" style="color: #2bff00;"></i>
            </div>
            <span class="nav-link-text ms-1">Peminjaman Selesai</span>
          </a>
        </li> --}}
