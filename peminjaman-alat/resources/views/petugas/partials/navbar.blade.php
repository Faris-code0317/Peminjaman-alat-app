           ...
           <div class="ms-md-auto pe-md-3">
              <form method="GET" action="" class="d-flex align-items-center gap-2">
               ...
               @if(in_array($segment, ['kategori']))
                ...
                @elseif(in_array($segment, ['peminjaman', 'peminjaman-aktif']))
                    <select name="id_alat"
               ...
               @elseif(in_array($segment, ['alat']))
                ...
                @elseif(in_array($segment, ['peminjaman-selesai']))
                    <select name="status"
                                class="form-select form-select-sm"
                                style="width: 140px;"
                                onchange="this.form.submit()">
                ...
                <!-- SUBMIT -->
                <button class="btn btn-sm btn-white" style="margin-top: 15px; padding: 8px; width: 100px;">
